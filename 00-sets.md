...
---
layout: cover
eyebrow: COMP455 · LECTURE 00
---

# Set Notation and Operations

A Discrete Structures Review.
...
> So we can say $A \subseteq B$.

## Example 2 

>Let $A = \{1,2,3\}$ and $B = \{3,2,1\}$.

>So we can say $A \subseteq B$ and $B \subseteq A$.
...
<!-- ---
layout: image-right
image: https://i.imgur.com/0c94JPz.png -->
...
<img src="https://i.imgur.com/R9uDave.png" width="150"/>
...
<img src="https://i.imgur.com/FOqpwIS.png" width="200"/>
...
Note that the size of a powerset can be calculated this way: $|\mathcal{P}(A)| = 2^{|A|}$
